...
<body>
  ...
  $userType=$row['Type'];
  if($userType=='Student'){
	$sql_instance="SELECT * FROM busDB.student WHERE RollNo=".$userID.";";
  ...
  elseif($userType=='Faculty'){
	$sql_instance="SELECT * FROM busDB.student WHERE FID=".$userID.";";
	$result = $conn->query($sql_instance);
	$row = $result->fetch_assoc();
	echo '<center><div class="container-fluid">
					<div class="card bg-info pl-2" style="width:25%">
						<br><br>
					    <div class="card-header"><h3>Your busDB Profile</h3></div><br><br>
